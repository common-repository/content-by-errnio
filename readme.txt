...
In addition, without adding **ads** or **banners**, errnio can enhance your revenue. Make **more** money from your site with **no more** banners or ads. No more pushy advertising, be part of the revolution. On our **gesture** plugin we can integrate recommended content from around the web, to enhance your site revenue.  See more about our features and how our product works at <a href="http://www.errnio.com" target="_blank">errnio.com</a>

= Features =
Main features include of the following items and actions:

* **Automatic Content Recommendation** - Our plugin automatically scans and indexes your content so that it can be served to the gallery for every user. Note that it may take a few hours for this to be fully indexed, depending on the amount of articles and traffic to your site.
* **Gesture reaction to scroll** - The gallery appears only when the user scroll up after reading a certain amount of the article, and only shows when they are at the top of the site.
* **Easy Reading Gallery** - Once activated, the gallery is easily readable on mobile and features up to 3 articles.
...
* Customise your selection of features to fit your site requirements.
...
**1.1 Text updates in readme and admin settings page

**1.2 Important update. Using wordpress API to allow errnio plugin to support any features turned on in errnio control panel

**1.2.1 Added X to notification bar in plugins page

**1.4 Simplified code on wp client side

**1.5 Added script versioning and parameters validation